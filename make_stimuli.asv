...
%   to MP4 (need AAC). 
cmd = ['ffmpeg -y -i '...
    '"C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS.mp4" -i "C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS;bandpass;0dB.wav"' ...
                    ' -map 0:0 -map 1 "C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS;bandpass;0dB.mp4"'];
...
cmd = ['ffmpeg -y -i '...
    '"C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS.mp4" -i "C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS;bandpass;+15dB.wav"' ...
                    ' -map 0:0 -map 1 "C:\Users\Public\GitHub\SIN\playback\MLST (Adult)\List_06\2_T9_060_HS;bandpass;+15dB.mp4"'];
...
% =================
createMLSTlookup('suffix', ';bandpass;0dB', 'testID', 'MLST (AV, Aided, SSN, 80 dB SPL, +0 dB SNR)', 'wav_regexp', '[0-9]{1,2}_T[0-9]{1,2}_[0-9]{3}_[HL][DS];bandpass;0dB.mp4$');
createMLSTlookup('suffix', ';bandpass;+15dB', 'testID', 'MLST (AV, Aided, SSN, 80 dB SPL, +0 dB SNR)', 'wav_regexp', '[0-9]{1,2}_T[0-9]{1,2}_[0-9]{3}_[HL][DS];bandpass;[+]15dB.mp4$');
...
audiowrite(fullfile(fileparts(which('runSIN')), 'playback', 'Noise', 'MLST_ISTS_4_talker;bandpass;0dB.wav'), ists_4talker, FS, 'BitsperSample', audio_bit_depth);
