...
match_spectra(hint_time_series, hint_spshn, ...
        'fsx', hint_fs, ...  
        'fsy', hint_fs, ...
        'plot', true, ...
        'frequency_range', [eps inf], ... % only work on the higher frequencies.
        'filter_order', spectral_match_filter_order, ...
        'window', pwelch_window, ...
        'noverlap', pwelch_noverlap, ...
        'nfft', pwelch_nfft);
...
[ists, ists_fs] = audioread(fullfile(fileparts(which('runSIN')), 'playback', 'Noise', 'ISTS-V1.0_60s_24bit;bandpass;0dB.wav'));
...
hagerman_audio_files = {hagerman_audio_files{1:40}}';
...
legend('Hagerman (40 HINT Sentences)', 'Hagerman SPSHN', 'Hagerman ISTS', 'location', 'NorthOutside');
ylabel('dB')
